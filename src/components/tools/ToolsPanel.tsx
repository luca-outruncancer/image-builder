...
export default function ToolsPanel({ onUploadClick }: ToolsPanelProps) {
  return (
    <div className="w-48 p-4 bg-black bg-opacity-60 backdrop-blur-sm border border-green-900/40 rounded-lg">
      <div className="mb-4">
      ...
      <Button
        ...
        className="w-full flex items-center gap-2 bg-white text-black hover:bg-green-400 hover:text-black"
      >
